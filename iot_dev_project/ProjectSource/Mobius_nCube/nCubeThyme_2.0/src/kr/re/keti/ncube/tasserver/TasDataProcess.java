...
public class TasDataProcess extends Thread {
	...
	/**
	 * findContainer Method Matching the container name in repository
	 * 
	 * @return
	 */
	...
	/**
	 * replaceContainer Method Replace the container in repository
	 * 
	 * @return
	 */
	...
	/**
	 * run Method Receive the TAS message and processing
	 */
	public void run() {
			...
			try {
				...
				if (containerMatch) {
					if (content.equals("hello")) {
						...
						TasSender.sendMessage(container.ctname,
								"{\"ctname\":\"" + container.ctname + "\",\"con\":\"hello\"}");
					} else if (content.equals("timeRequest")) {
						TasSender.sendMessage(container.ctname,
								"{\"ctname\":\"" + container.ctname + "\",\"con\":\"" + Long.toString(System.currentTimeMillis()) + "\"}");
					} else {
