...
public class ThymeMain {
	...
	public static void nCubeBroadCast() {
		try {
			DatagramSocket socket = new DatagramSocket();
			socket.setBroadcast(true);
			byte[] buffer = new String("nCube").getBytes();
	...
	public static void main(String[] args) throws Exception {
		...
		if (windows) {
			...
			InetSocketAddress serverSocketAddress = new InetSocketAddress(ip.getHostAddress(),
					Integer.parseInt(hostingAE.appPort));
